...
#      offline in seeded test mode (HikingTrailClosuresSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HikingTrailClosures_sdk.rb")
  SDK_CLASS = "HikingTrailClosuresSDK"
  ...
  SDK_BASE = "HikingTrailClosures_sdk"
