...
// HikingTrailClosures SDK pipeline test
//
...
{
    private static function utility(): HikingTrailClosuresUtility
    {
        return new HikingTrailClosuresUtility();
    }
    ...
    private static function ctx(array $over = []): HikingTrailClosuresContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HikingTrailClosuresContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HikingTrailClosuresOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HikingTrailClosuresError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HikingTrailClosuresOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HikingTrailClosuresMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HikingTrailClosuresOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HikingTrailClosuresMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HikingTrailClosuresOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HikingTrailClosuresMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HikingTrailClosuresSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HikingTrailClosuresMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HikingTrailClosuresResponse([]),
            'result' => new HikingTrailClosuresResult([]),
        ]);
        [, $err] = HikingTrailClosuresMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HikingTrailClosuresSpec([]),
            'response' => null,
            'result' => new HikingTrailClosuresResult([]),
        ]);
        [, $err] = HikingTrailClosuresMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HikingTrailClosuresSpec(['step' => 's']),
            'response' => new HikingTrailClosuresResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HikingTrailClosuresResult([]),
        ]);
        [, $err] = HikingTrailClosuresMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HikingTrailClosuresSpec(['step' => 's']),
            'response' => new HikingTrailClosuresResponse(self::resp(200, ['v' => 1])),
            'result' => new HikingTrailClosuresResult([]),
        ]);
        [, $err] = HikingTrailClosuresMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HikingTrailClosuresSpec(['step' => 's']),
            'response' => new HikingTrailClosuresResponse(self::resp(200, ['v' => 2])),
            'result' => new HikingTrailClosuresResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HikingTrailClosuresMakeResponse::call($ctx);
    ...
    {
        $preset = new HikingTrailClosuresResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HikingTrailClosuresSpec([]),
            'response' => new HikingTrailClosuresResponse([]),
            'result' => new HikingTrailClosuresResult([]),
        ...
        [$got, $err] = HikingTrailClosuresMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HikingTrailClosuresResult([])]);
        [, $err] = HikingTrailClosuresMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HikingTrailClosuresSpec([]), 'result' => null]);
        [, $err] = HikingTrailClosuresMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HikingTrailClosuresSpec(['step' => 's']),
            'result' => new HikingTrailClosuresResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HikingTrailClosuresOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HikingTrailClosuresMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HikingTrailClosuresSpec(['step' => 's']),
            'result' => new HikingTrailClosuresResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HikingTrailClosuresOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HikingTrailClosuresMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HikingTrailClosuresResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HikingTrailClosuresSpec([]),
            'result' => new HikingTrailClosuresResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HikingTrailClosuresMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HikingTrailClosuresMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HikingTrailClosuresError('boom', 'boom');
        $utility->fetcher = function (HikingTrailClosuresContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HikingTrailClosuresSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HikingTrailClosuresMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HikingTrailClosuresContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HikingTrailClosuresMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HikingTrailClosuresResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HikingTrailClosuresMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HikingTrailClosuresContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HikingTrailClosuresSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HikingTrailClosuresMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HikingTrailClosuresResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HikingTrailClosuresSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HikingTrailClosuresMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HikingTrailClosuresMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HikingTrailClosuresMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HikingTrailClosuresResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HikingTrailClosuresDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HikingTrailClosuresResult(['ok' => false])]);
        $this->expectException(HikingTrailClosuresError::class);
        HikingTrailClosuresDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HikingTrailClosuresResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HikingTrailClosuresMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HikingTrailClosuresMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HikingTrailClosuresBaseFeature();
        $b = new HikingTrailClosuresBaseFeature();
        HikingTrailClosuresFeatureAdd::call($ctx, $a);
        HikingTrailClosuresFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HikingTrailClosuresBaseFeature
    {
        $f = new HikingTrailClosuresBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HikingTrailClosuresFeatureAdd::call($ctx, self::named_feature('a'));
        HikingTrailClosuresFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HikingTrailClosuresFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HikingTrailClosuresFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HikingTrailClosuresFeatureAdd::call($ctx, $replace);
        ...
        HikingTrailClosuresFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HikingTrailClosuresContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HikingTrailClosuresSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HikingTrailClosuresPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HikingTrailClosuresPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HikingTrailClosuresResponse(['headers' => null]),
            'result' => new HikingTrailClosuresResult([]),
        ]);
        HikingTrailClosuresResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HikingTrailClosuresResultBody::call($ctx);
