...
// HikingTrailClosures SDK utility: fetcher

class HikingTrailClosuresFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HikingTrailClosuresSDK/1.0)';
    ...
    public static function call(HikingTrailClosuresContext $ctx, string $fullurl, array $fetchdef): array
    {
