...
// HikingTrailClosures SDK utility: graphql
//
...
class HikingTrailClosuresGraphql
{
    ...
    // equivalent.
    public static function body(HikingTrailClosuresContext $ctx): mixed
    {
    ...
    public static function errors(HikingTrailClosuresContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
