...
// HikingTrailClosures SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HikingTrailClosuresMakeRequest
{
    public static function call(HikingTrailClosuresContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HikingTrailClosuresResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HikingTrailClosuresResponse($fetched);
        } else {
