...
// HikingTrailClosures SDK utility: make_options

class HikingTrailClosuresMakeOptions
{
    ...
    public static function call(HikingTrailClosuresContext $ctx): array
    {
        ...
        //
        // `HikingTrailClosuresSchema::optspec()` is built from the model:
        ...
        $optspec = HikingTrailClosuresSchema::optspec();
