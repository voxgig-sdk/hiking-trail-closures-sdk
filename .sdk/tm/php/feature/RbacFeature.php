...
// HikingTrailClosures SDK rbac feature
...
class HikingTrailClosuresRbacFeature extends HikingTrailClosuresBaseFeature
{
    ...
    private function _required(HikingTrailClosuresContext $ctx): ?string
    {
    ...
    private function _reject(HikingTrailClosuresContext $ctx, string $required): void
    {
    ...
    private function _track(HikingTrailClosuresContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
