...
// HikingTrailClosures SDK audit feature
...
class HikingTrailClosuresAuditFeature extends HikingTrailClosuresBaseFeature
{
    ...
    private function _emit(HikingTrailClosuresContext $ctx, string $outcome): void
    {
