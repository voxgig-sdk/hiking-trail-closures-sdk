...
// HikingTrailClosures SDK timeout feature
...
class HikingTrailClosuresTimeoutFeature extends HikingTrailClosuresBaseFeature
{
    ...
    private function _with_timeout(HikingTrailClosuresContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HikingTrailClosuresContext $_ctx, float $ms): void
    {
        $client = $this->client;
