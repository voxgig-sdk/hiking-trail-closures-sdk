...
// HikingTrailClosures SDK clienttrack feature
...
class HikingTrailClosuresClienttrackFeature extends HikingTrailClosuresBaseFeature
{
    ...
    public function PostConstruct(HikingTrailClosuresContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HikingTrailClosures-SDK';
