...
// HikingTrailClosures SDK proxy feature
...
class HikingTrailClosuresProxyFeature extends HikingTrailClosuresBaseFeature
{
    ...
    public function init(HikingTrailClosuresContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HikingTrailClosuresContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
