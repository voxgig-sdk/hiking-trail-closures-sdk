...
// HikingTrailClosures SDK ratelimit feature
...
class HikingTrailClosuresRatelimitFeature extends HikingTrailClosuresBaseFeature
{
    ...
    private function _acquire(HikingTrailClosuresContext $ctx): void
    {
    ...
    private function _track(HikingTrailClosuresContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
