...
from projectname_sdk.core.control import HikingTrailClosuresControl
...
class HikingTrailClosuresContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HikingTrailClosuresControl()
        ...
        if isinstance(sp, HikingTrailClosuresSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HikingTrailClosuresResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HikingTrailClosuresResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HikingTrailClosuresOperation({})
        ...
        op = HikingTrailClosuresOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return HikingTrailClosuresError(code, msg, self)
