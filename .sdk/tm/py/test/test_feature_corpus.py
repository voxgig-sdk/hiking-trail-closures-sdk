# HikingTrailClosures SDK feature corpus test
#
...
def _client(kase):
    ...
    HikingTrailClosuresSDK(...), not HikingTrailClosuresSDK.test(...): the `test` feature is
    ...
    return HikingTrailClosuresSDK(opts)
