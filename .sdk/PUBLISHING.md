...
|---|---|---|
| `ts/` | @voxgig-sdk/hiking-trail-closures-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hiking-trail-closures-sdk \
      --repository voxgig-sdk/hiking-trail-closures-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hiking-trail-closures-sdk` shows it, and
`npm trust revoke @voxgig-sdk/hiking-trail-closures-sdk --id=<id>` removes it.
