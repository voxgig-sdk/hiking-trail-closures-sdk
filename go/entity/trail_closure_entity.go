...
import (
	...
	vs "github.com/voxgig-sdk/hiking-trail-closures-sdk/go/utility/struct"
)

type TrailClosureEntity struct {
	name    string
	client  *core.HikingTrailClosuresSDK
...
func NewTrailClosureEntity(client *core.HikingTrailClosuresSDK, entopts map[string]any) *TrailClosureEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TrailClosureEntity) GetName() string { return e.name }
...
func (e *TrailClosureEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TrailClosureEntity) Deleted() bool {
	return e.deleted
}


func (e *TrailClosureEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTrailClosureEntity(e.client, opts)
}

func (e *TrailClosureEntity) Data(args ...any) any {
...
func (e *TrailClosureEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TrailClosure; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TrailClosureEntity) DataTyped(data ...TrailClosure) TrailClosure {
	if len(data) > 0 {
		return typedFrom[TrailClosure](e.Data(asMap(data[0])))
	}
	return typedFrom[TrailClosure](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TrailClosure (all fields
// optional at the wire level).
func (e *TrailClosureEntity) MatchTyped(match ...TrailClosure) TrailClosure {
	if len(match) > 0 {
		return typedFrom[TrailClosure](e.Match(asMap(match[0])))
	}
	return typedFrom[TrailClosure](e.Match())
}
...
func (e *TrailClosureEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TrailClosureEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TrailClosureEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TrailClosureListMatch and returns []TrailClosure. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TrailClosureEntity) ListTyped(reqmatch TrailClosureListMatch, ctrl map[string]any) ([]TrailClosure, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TrailClosure](res), nil
}



func (e *TrailClosureEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TrailClosureEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TrailClosureEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TrailClosureEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
