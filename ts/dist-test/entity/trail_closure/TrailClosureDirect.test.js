...
(0, node_test_1.describe)('TrailClosureDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HikingTrailClosuresSDK({
    ...
    (0, node_test_1.test)('direct-list-trail_closure', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-trail_closure', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.HIKING_TRAIL_CLOSURES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HikingTrailClosuresSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['HIKING_TRAIL_CLOSURES_TEST_TRAIL_CLOSURE_ENTID'];
    ...
    const client = new __1.HikingTrailClosuresSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TrailClosureDirect.test.js.map