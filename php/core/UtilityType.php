...
// HikingTrailClosures SDK utility type

class HikingTrailClosuresUtility
{
    ...
    public static function copy(HikingTrailClosuresUtility $src): HikingTrailClosuresUtility
    {
        $u = new HikingTrailClosuresUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
