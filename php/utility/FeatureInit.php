...
// HikingTrailClosures SDK utility: feature_init

class HikingTrailClosuresFeatureInit
{
    public static function call(HikingTrailClosuresContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
