...
// HikingTrailClosures SDK streaming feature
...
class HikingTrailClosuresStreamingFeature extends HikingTrailClosuresBaseFeature
{
    ...
    private function _iterate(HikingTrailClosuresResult $result): \Generator
    {
    ...
    private function _streamable(HikingTrailClosuresContext $ctx): bool
    {
