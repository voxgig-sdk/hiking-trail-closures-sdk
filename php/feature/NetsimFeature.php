...
// HikingTrailClosures SDK netsim feature
...
class HikingTrailClosuresNetsimFeature extends HikingTrailClosuresBaseFeature
{
    ...
    private function _simulate(HikingTrailClosuresContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HikingTrailClosuresContext $ctx, array $applied): void
    {
        $client = $this->client;
