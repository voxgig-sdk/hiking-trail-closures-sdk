...
// HikingTrailClosures SDK metrics feature
...
class HikingTrailClosuresMetricsFeature extends HikingTrailClosuresBaseFeature
{
    ...
    private function _record(HikingTrailClosuresContext $ctx, bool $ok): void
    {
