...
// HikingTrailClosures SDK cache feature
...
class HikingTrailClosuresCacheFeature extends HikingTrailClosuresBaseFeature
{
    ...
    private function _through(HikingTrailClosuresContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
