...
// HikingTrailClosures SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HikingTrailClosuresSDK::test)
...
{
    private const SDK_CLASS = 'HikingTrailClosuresSDK';
    ...
    private const SDK_BASE = 'hikingtrailclosures_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hikingtrailclosures_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
