...
from hikingtrailclosures_sdk.utility import register

# Load features
from hikingtrailclosures_sdk.feature.base_feature import HikingTrailClosuresBaseFeature
from hikingtrailclosures_sdk.features import _has_feature, _make_feature
...
class HikingTrailClosuresSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = HikingTrailClosuresUtility()
    ...
    def get_utility(self):
        return HikingTrailClosuresUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HikingTrailClosuresSDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def TrailClosure(self, data=None) -> "TrailClosureEntity":
        """Entity factory: client.TrailClosure().list() / client.TrailClosure().load({"id": ...})."""
        from hikingtrailclosures_sdk.entity.trail_closure_entity import TrailClosureEntity
        return TrailClosureEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "HikingTrailClosuresSDK":
        if sdkopts is None:
            sdkopts = {}
