...
from hikingtrailclosures_sdk.hikingtrailclosures_types import (
    TrailClosure,
    TrailClosureListMatch,
)
...
class TrailClosureEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TrailClosureEntity(self._client, opts)
    ...
    def data_get(self) -> TrailClosure:
    ...
    def match_get(self) -> TrailClosure:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TrailClosure]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TrailClosure().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
