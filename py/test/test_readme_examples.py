# HikingTrailClosures SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HikingTrailClosuresSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HikingTrailClosuresSDK(...) and HikingTrailClosuresSDK.test(...) become
#      HikingTrailClosuresSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hikingtrailclosures_sdk"
_SDK_CLASS = "HikingTrailClosuresSDK"
