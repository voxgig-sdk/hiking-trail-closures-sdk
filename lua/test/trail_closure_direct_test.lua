...
describe("TrailClosureDirect", function()
  it("should direct-list-trail_closure", function()
    local setup = trail_closure_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-trail_closure", setup.live and "live" or "unit")
