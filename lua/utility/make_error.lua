...
local function make_error_util(ctx, err)
  ...
  local msg = "HikingTrailClosuresSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = HikingTrailClosuresError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == HikingTrailClosuresError then
