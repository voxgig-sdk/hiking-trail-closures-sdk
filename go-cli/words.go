...
func registerSDKWords(r *eng.Registry, client *sdk.HikingTrailClosuresSDK) {
...
func runOp(client *sdk.HikingTrailClosuresSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
