// Command HikingTrailClosures-mcp is an MCP server exposing the HikingTrailClosures
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HikingTrailClosures_list  — list records of an entity
//	HikingTrailClosures_load  — load a single record of an entity
//
