...
type Args struct {
	Entity string         `json:"entity" jsonschema:"trail_closure"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.HikingTrailClosuresSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "hiking-trail-closures_list",
		Description: "List records from HikingTrailClosures. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "hiking-trail-closures_load",
		Description: "Load a single record from HikingTrailClosures. " +
...
func runOp(client *sdk.HikingTrailClosuresSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.HikingTrailClosuresSDK, name string) (sdk.HikingTrailClosuresEntity, error) {
	switch strings.ToLower(name) {
	case "trail_closure":
		return client.TrailClosure(nil), nil
